...
// --- Wi-Fi (Layer 4) ---
// Fill these in with your actual network. Kept as plain #defines
// rather than a separate secrets file for now, matching how
// ESPNOW_PEER_MAC is handled below — revisit if this ever needs to
// go in a gitignored file instead of committed source.
